...
func (_m *PriceRepository) Create(ctx context.Context, rec *pricemodel.CreatePrice) error {
...
func (_m *PriceRepository) Get(ctx context.Context, rec *pricemodel.GetPrice) (pricemodel.Prices, error) {
	ret := _m.Called(ctx, rec)
...
func (_m *PriceRepository) Update(ctx context.Context, rec *pricemodel.UpdatePrice) error {
	ret := _m.Called(ctx, rec)
